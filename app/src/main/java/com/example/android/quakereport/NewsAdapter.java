...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String extractedHeadline = currentEarthquake.getHeadline();

        headlineView.setText(extractedHeadline);

        TextView categoryView = (TextView) listItemView.findViewById((R.id.category));

        String extractedCategory = currentEarthquake.getCategory();

        categoryView.setText(extractedCategory);


        TextView dateView = (TextView) listItemView.findViewById((R.id.date));

        String extractedDate = currentEarthquake.getDate();
